            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="book.subtitle.label" default="Subtitle" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: bookInstance, field: "subtitle")}</td>
